 ...
 */
class ResearchpartnerTest extends \TYPO3\TestingFramework\Core\Unit\UnitTestCase
{
    /**
     * @var \PEEC\PeecExtension\Domain\Model\Researchpartner
     */
    ...
    {
        parent::setUp();
        $this->subject = new \PEEC\PeecExtension\Domain\Model\Researchpartner();
    }
